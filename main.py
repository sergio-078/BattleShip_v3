...
class Game:
    ...
    def greet(self):
        ...
        print('Компьютер автоматически расставит корабли на игровом поле.')
        print('Для выстрела Вам необходимо будет указать координаты в цифровом формате:')
        print('     - первая цифра - номер строки от 1 до 6,')
        print('     - пробел,')
        print('     - вторая цифра - номер столбца от 1 до 6.')
        print('Например: 2 4.')
        print('Ниже представлены игровые доски (Ваша и искусственного интеллекта).')
